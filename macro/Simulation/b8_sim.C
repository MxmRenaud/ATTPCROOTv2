void b8_sim(Int_t nEvents = 1000, TString mcEngine = "TGeant4")
{
  ...
  cout<<endl<<"scatFus = "<<scatFus<<endl;
  	z1 = 5;
  	a1 = 8;
  	m1 = 7.9623; //GeV TODO: WHAT ?
  	z2 = 18;
  	a2 = 40;
  	m2 = 39.6562; //GeV TODO: WHAT ?
  }
  if (scatFus == 1){
  cout<<endl<<"scatFus = "<<scatFus<<endl;
  	z1 = 1;
  	...
  	z2 = 22;
  	a2 = 47;
  	m2 = 47*(1-0.008661); //GeV TODO: WHAT ?
  }
  else if (scatFus == 2){
  cout<<endl<<"scatFus = "<<scatFus<<endl;
  	z1 = 0;
  	...
  	z2 = 23;
  	a2 = 47;
  	m2 = 47*(1-0.008582); //GeV TODO: WHAT ?
  }
  else if (scatFus == 3){
  cout<<endl<<"scatFus = "<<scatFus<<endl;
  	z1 = 4;
  	a1 = 7;
  	m1 = 7*(1-0.005371); //GeV TODO: WHAT ?
  	z2 = 19;
  	a2 = 41;
  	m2 = 41*(1-0.008576); //GeV TODO: WHAT ?
  }
  else{cout<<"Please use a valid option for your kinematic case.\n\n";gApplication->Terminate();}
  
  	

  // Output file name
  TString outFile ="./data/attpcsim_proto_b8-fusbe.root";

  // Parameter file name
  TString parFile="./data/attpcpar_proto_b8-fusbe.root";
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
                ...
                Int_t z = 5;  // Atomic number
	              ...
	              Double_t pz = 0.56/a;  // Z-Momentum / per nucleon!!!!!!
  	            Double_t BExcEner = 0.0;
                Double_t Bmass = 7.9623; //Mass in GeV
                ...
                Double_t TargetMass = 39.6562;//Mass in GeV
		 ...
		 // Variables for 2-Body kinematics reaction
		  ...
		  ExE.push_back(BExcEner);
                  ...
                  // ---- Target ----
                 Zp.push_back(18); // alpha
		             Ap.push_back(40); //
		             Qp.push_back(0); //
		             Pxp.push_back(0.0);
                 Pyp.push_back(0.0);
		             Pzp.push_back(0.0);
                 Mass.push_back(39.65);
		             ExE.push_back(0.0);//In MeV

                  //--- Scattered -----
                Zp.push_back(z1); // TRACKID=1
          	 	  Ap.push_back(a1); //
          		  Qp.push_back(0);
          		  Pxp.push_back(0.0);
          		  Pyp.push_back(0.0);
                  ...
                  // ---- Recoil -----
		             Zp.push_back(z2); // alpha or 11B  TRACKID=2
		             Ap.push_back(a2); //
		             Qp.push_back(0); //
		             Pxp.push_back(0.0);
                 Pyp.push_back(0.0);
