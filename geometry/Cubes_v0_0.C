...
const TString geoVersion = "Cubes_v0.0";
...
const TString CubesVolumeMedium = "steel";
const TString MediumVacuum = "vacuum4";
const TString FieldCageCub = "G10";
...
// Field cage
const Float_t field_side = 35.;
const Float_t drift_length = 45.;
const Float_t field_thickness = 0.5;
...
TGeoManager* gGeoMan = new TGeoManager("Cubes_v0","Cubes_v0");;  // Pointer to TGeoManager instance
...
TGeoVolume* create_detector()
{
  ...
  // needed materials
  TGeoMedium* OuterCubes   = gGeoMan->GetMedium(CubesVolumeMedium);
...
/*  //Field cage 
  ...
  TGeoVolume *fc_volume2 = gGeoManager->MakeBox("fc_volume",fc,drift_length+field_thickness,field_side+field_thickness,field_side+field_thickness);
  TGeoVolume *fc_volume = fc_volume2-fc_volume1;
 ...
 /* //Outer shell  
  TGeoVolume *chamber_volume = gGeoManager->MakeBox("chamber_volume", OuterCubes,chamber_thickness/2, chamber_diameter/2, chamber_length/2);
