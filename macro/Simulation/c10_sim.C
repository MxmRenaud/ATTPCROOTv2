...
>>>>>>> 879025c3d85bea442687c40eba9d539aacadacea
{
  ...
  // Output file name
  TString outFile ="./data/attpcsim_proto_c10.root";

  // Parameter file name
  TString parFile="./data/attpcpar_proto_c10.root";
  ...
  ATVertexPropagator* vertex_prop = new ATVertexPropagator(); // not used?
 ...
 // ------------------------------------------------------------------------
  ...
  // Beam Information
                Int_t z = 6;  // Atomic number
	              ...
	              Double_t pz = 0.80893306/a;  // Z-Momentum / per nucleon!!!!!!
  	            Double_t BExcEner = 0.0; //
                Double_t Bmass = 9.33063888; //Mass in GeV
                Double_t NomEnergy = 35.0; //Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC
